...
\begin{figure}[H]
  \centering
  \includegraphics[width=8cm]{notacio2x2.png}
  \caption{Notació completa dels moviments del cub de Rubik 2$\times$2.}
  \label{fig:notacio2x2}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5cm]{idle_x.jpeg}
  \hfill
  \includegraphics[width=5cm]{idle_y.jpeg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5cm]{tiltx_real.jpeg}
  \hfill
  \includegraphics[width=5cm]{tilty_real.jpeg}
...
tres vídeos que mostren l'execució completa del pla: un en \textbf{simulació},
un amb una execució bàsica del \textbf{robot real} i una demo real més
complexa, amb una barreja menys trivial del cub. Feu clic sobre cada imatge o
requadre per accedir al vídeo corresponent.
...
\end{subfigure}
    ...
    \centering
    \href{https://drive.google.com/file/d/1kVuA_HTYCjWttAMZSw8lqLtLuxzHSrzg/view?usp=sharing}{%{%
        \includegraphics[width=\textwidth]{img/miniatura_demo_final.png}}
    \caption{Execució real amb una barreja més complexa}
    \label{fig:video-real-complex}
\end{subfigure}
...
obertures i tancaments de la pinça per manipular el cub. Els vídeos mostren la
resolució completa sobre el muntatge físic, incloent-hi una demo addicional
amb una configuració inicial més complexa i representativa d'un cas menys
trivial (Figura~\ref{fig:video-real-complex}).
