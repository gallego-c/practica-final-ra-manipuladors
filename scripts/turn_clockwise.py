...
program = (
    ...
    "  # 2. Rotar joint 6\n"
    "  q_rot = [0.84736, -1.02992, 0.80599, -1.34670, -1.57080, q_start[5] + 1.670796]\n"
    "  movej(q_rot, a=0.5, v=0.2)\n"
    "  # 3. Volver a bajar a la pose original (pero con joint 6 rotado)\n"
    "  q_down = [q_start[0], q_start[1], q_start[2], q_start[3], q_start[4], q_start[5] + 1.670796]\n"
...
time.sleep(6.5)  # Dar margen para que terminen los tres movimientos
sock.close()
