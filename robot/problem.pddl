...
(define (problem rubik-robot-scrambled)
  ...
  (:init
    (cube-on-fixture)
    (color-at u-ufr orange)
    (color-at u-ufl green)
    (color-at u-ubr green)
    (color-at u-ubl yellow)
    (color-at d-dfr white)
    (color-at d-dfl yellow)
    (color-at d-dbr yellow)
    (color-at d-dbl red)
    (color-at f-ufr green)
    (color-at f-ufl yellow)
    (color-at f-dfr orange)
    (color-at f-dfl red)
    (color-at b-ubr blue)
    (color-at b-ubl red)
    (color-at b-dbr red)
    (color-at b-dbl green)
    (color-at l-ufl white)
    (color-at l-ubl orange)
    (color-at l-dfl blue)
    (color-at l-dbl blue)
    (color-at r-ufr white)
    (color-at r-ubr blue)
    (color-at r-dfr orange)
    (color-at r-dbr white)
  )
  (:goal (and
    (cube-on-fixture)
